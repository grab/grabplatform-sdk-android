...
import com.grab.partner.sdk.sampleappkotlin.wrapper.utils.PROTECTED_RESOURCE_ENDPOINT_ATTRIBUTE
import com.grab.partner.sdk.sampleappkotlin.wrapper.utils.Utility
import io.reactivex.Observable
import javax.inject.Inject

class GrabRepositoryImpl @Inject constructor(private val context: Context,
        private val grabAPI: GrabAPI
) : GrabRepository {
